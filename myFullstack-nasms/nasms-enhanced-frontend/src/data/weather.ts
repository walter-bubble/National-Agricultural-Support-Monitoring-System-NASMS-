...
export interface WeatherSnapshot {
  ...
  icon: string;
  gradient: string;
  /** Advisory text — may include HTML for <strong> emphasis. */
  advisory: string;
}
...
export const WEATHER: Record<RegionId, WeatherSnapshot> = {
...
export const FORECASTS: Record<RegionId, ForecastDay[]> = {
